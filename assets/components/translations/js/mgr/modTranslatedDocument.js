...
Ext.extend(MODx.panel.Resource,MODx.FormPanel,{
    ...
    ,classLexiconKey: 'translations.article'
    ,rteElements: 'ta'
    ,rteLoaded: false
    ,setup: function() {
        if (!this.initialized) { 
    ...
    ,getFields: function(config) {
        ...
        it.push({
            title: _('translations.translations')
    ...
    ,getMainLeftFields: function(config) {
        ...
        return [{
            xtype: 'textfield'
            ,fieldLabel: _('translations.headline')+'<span class="required">*</span>'
            ...
            xtype: 'textarea'
            ,fieldLabel: _('translations.standfirst')
